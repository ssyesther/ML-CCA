...
def main(domain, init_method, new_query_option, qinit, seed):
    ...
    for i in range(num_bidders):
        ...
        if domain == 'GSVM':
            ...
            end_linear_item_prices_multiplier = 50
    ...
    mechanism_parameters = {'Qinit': qinit,  # TODO: CHANGE THIS BACK TO 20 
                            ...
                            "profit_max_grid": [5, 10],   # NOTE: from this you can change the number of profit max bids that will be used
    ...
    if mechanism_parameters['new_query_option'] == 'cca':
        if domain in ['LSVM', 'MRVM', 'SRVM', 'MSVM']: 
    ...
    if mechanism_parameters['new_query_option'] == 'cca':  
        ...
        if domain in ['GSVM', 'LSVM', 'SRVM']:
            ...
            mechanism_parameters['cca_increment'] = 0.2
